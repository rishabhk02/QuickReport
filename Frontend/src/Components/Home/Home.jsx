...
const img2 = new URL('../../Images/HomeCarouselImage/carouselImage2.jpg', import.meta.url);
const img3 = new URL('../../Images/HomeCarouselImage/carouselImage3.jpg', import.meta.url);
const img4 = new URL('../../Images/HomeCarouselImage/carouselImage4.webp', import.meta.url);
const img5 = new URL('../../Images/HomeCarouselImage/carouselImage5.avif', import.meta.url);
const img6 = new URL('../../Images/HomeCarouselImage/carouselImage6.jpeg', import.meta.url);
   ...
   return (
      <>
         <div className="homeDiv" style={{ width: "100%", backgroundColor: "white" }}>
            ...
            <div style={{ width: "100%", backgroundColor: "black" }} className="p-4"><h3 className="text-center" style={{ color: "white" }}>© 2024 www.quickreport.com | All right reseverd</h3></div>
         </div>
      </>
   )
}